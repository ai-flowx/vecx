...
- `id`: node id
- `name`: node name
- `type`: node type (file, class, function, variable)
- `filePath`: file path
- `language`: programming languag
- `fullName`: full name
- `lineNumber`: line number
- `description`: decription generated by llm
...
- `depend`: file/module/type/function dependency
